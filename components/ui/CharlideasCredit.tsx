export function CharlideasCredit() {
  return (
    <div className="flex items-center justify-center gap-1.5 text-[#5A5B5A] text-[12px]">
      <span>Página desarrollada por</span>
      <span className="inline-flex items-center gap-0.5 font-semibold">
        <span>charl</span>
        <span className="text-[#00b4b9]">!</span>
        <span>deas</span>
      </span>
      <svg
        version="1.2"
