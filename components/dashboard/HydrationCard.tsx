...
export function HydrationCard({ totalAmount, entries, onAddClick, onClick }: HydrationCardProps) {
  return (
    <div 
      className={`bg-[#6484E2] rounded-[30px] p-[10px] shadow-[0_2px_10px_rgba(0,0,0,0.10)] relative overflow-hidden min-w-[170px] min-h-[100px] flex flex-col ${onClick ? 'cursor-pointer' : ''}`}
      onClick={onClick}
    >
